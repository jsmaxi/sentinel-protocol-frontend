  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 z-10">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 animate-fade-in">
              Sentinel connects users seeking insurance with investors
              interested in assuming risks, all through transparent and
        ...
        <section
          id="community"
          className="relative py-20 z-10 animate-on-scroll"
        >
          <div className="container mx-auto px-4 text-center">
